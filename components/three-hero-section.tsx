...
export const ThreeHeroSection = () => {
  ...
  useEffect(() => {
    const initThree = () => {
      ...
      const bloomPass = new UnrealBloomPass(new THREE.Vector2(window.innerWidth, window.innerHeight), 0.5, 0.3, 0.9)
  ...
  useEffect(() => {
    ...
    // Animate subtitle - simplified to single line
    ...
    // Setup scroll-triggered animations for hero content
  ...
  return (
    <div ref={containerRef} className="hero-container cosmos-style">
      ...
      <div ref={menuRef} className="side-menu" style={{ visibility: "hidden" }}>
        ...
        <div className="vertical-text">LINGUA</div>
      </div>

      {/* Main content - Simplified subtitle */}
      ...
      {/* Additional sections for scrolling - simplified */}
      <div className="scroll-sections">
        {[...Array(2)].map((_, i) => {
          ...
          const subtitles = {
            0: "Experience real conversations with AI coaching",
            1: "Achieve fluency through personalized feedback",
          }

          return (
            <section key={i} className="content-section">
              <h1 className="hero-title">{splitTitle(titles[i] || "DEFAULT")}</h1>
